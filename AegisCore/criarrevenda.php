            ...
            <div class="card-body">
                ...
                <form action="criarrevenda.php" method="POST">
                    <div class="form-grid">
                        ...
                        <div class="form-field">
                            <label><i class='bx bx-layer icon-group'></i> Limite (MÃ¡x. <?php echo $_SESSION['tipodeconta'] == 'Credito' ? $_SESSION['limite'] : $restante; ?>)</label>
    ...
    <div class="modal-container">
        <div class="modal-content">
            ...
            <div class="modal-body" id="divToCopy">
                ...
                <div class="modal-info-card">
                    <div class="modal-info-row">
                        <div class="modal-info-label"><i class='bx bx-store-alt' style="color:#818cf8;"></i> UsuÃ¡rio</div>
                ...
                <hr class="modal-divider">
                <p class="modal-success-title">âœ¨ Revendedor criado com sucesso! âœ¨</p>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    function copiarDados() {
        ...
        var texto = "âœ… REVENDEDOR CRIADO COM SUCESSO!\n";
        texto += "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”\n\n";
        texto += "ðŸ‘¤ Login: " + u + "\n";
        texto += "ðŸ”‘ Senha: " + s + "\n";
        texto += "ðŸ“… Validade: " + v + "\n";
        texto += "ðŸ—“ï¸ Vencimento: " + venc + "\n";
        texto += "ðŸ”— Limite: " + l + " conexÃµes\n";
        texto += "ðŸ’° Valor do Revendedor: " + val + "\n";
    ...
    function shareOnWhatsApp() {
        var text = "ðŸŽ‰ Revendedor Criado! ðŸŽ‰\n"
            ...
            + "ðŸŽ¯ Validade: <?php echo $show_modal ? addslashes($modal_validade) : ''; ?>\n"
            + "ðŸ“… Vencimento: <?php echo $show_modal && !empty($modal_data_validade) && $modal_validade != 'Nunca' ? date('d/m/Y', strtotime($modal_data_validade)) : 'Nunca'; ?>\n"
            + "ðŸ•Ÿ Limite: <?php echo $show_modal ? $modal_limite : ''; ?>\n"
            + "ðŸ’° Valor do Revendedor: R$ <?php echo number_format(floatval($modal_valor_revenda), 2, ',', '.'); ?>\n"
