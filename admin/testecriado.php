<?php // @ioncube.dk $kOc5k3wJRKbpQVn4eFK5X2uqqpduW8WWcQVpavWeM9vGYzqzzf -> "TvElGMdz8wa1V3uq3DRqlbtRKqz5MdNl8qoPWwiEr9uCK2Q8Gs" RANDOM
    ...
    function aleatorio_testecriado($input)
    {
        ?>
<?php 
error_reporting(0);
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="info-card" id="divToCopy">
                    <div class="divider">
                        <span class="divider-text">🎉 TESTE CRIADO 🎉</span>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-content">
                            ...
                            <div class="info-value"><?php echo $validade; ?> Minutos</div>
                        </div>
                    </div>
...
<?php
    ...
    aleatorio_testecriado($kOc5k3wJRKbpQVn4eFK5X2uqqpduW8WWcQVpavWeM9vGYzqzzf);
?>